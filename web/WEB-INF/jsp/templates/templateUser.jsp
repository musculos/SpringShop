...
<html>
    <head>
        ...
        <script type="text/javascript" src="${pageContext.servletContext.contextPath }/assets/js/move-top.js"></script>
        <script type="text/javascript" src="${pageContext.servletContext.contextPath }/assets/js/easing.js"></script>
        ...
        <!-- start menu -->
        <link href="${pageContext.servletContext.contextPath }/assets/css/megamenu.css" rel="stylesheet" type="text/css" media="all" />
        <script type="text/javascript" src="${pageContext.servletContext.contextPath }/assets/js/megamenu.js"></script>
    ...
    <body> 
        ...
        <div class="container">
            ...
            <div class="header-top">
                <div class="logo">
                    <a href="index.html"><img src="${pageContext.servletContext.contextPath }/assets/images/logo.png" alt="" ></a>
                </div>
            ...
            <div class="header-bottom">
                <div class="top-nav">
                    ...
                    <ul class="megamenu skyblue">
                        <li ${action eq 'home' ? 'class="selected"' : '' }><a href="${pageContext.request.contextPath }/home.htm">Home</a>
                            <div class="megapanel">
                                <div class="row">
                                    <div class="col1">
                                        <div class="h_nav">
                        ...
                        <li ${action eq 'about' ? 'class="selected"' : '' }><a href="${pageContext.request.contextPath }/about.htm">About</a></li>
                        <li ${action eq 'list' ? 'class="selected"' : '' }><a href="${pageContext.request.contextPath }/product/list.htm">Products</a>
                            <div class="megapanel">
                                <div class="row">
                                    <div class="col1">
                                        <div class="h_nav">
                        ...
                        <li ${action eq 'specials' ? 'class="selected"' : '' }><a href="${pageContext.request.contextPath }/product/specials.htm">Special</a>
                                ...
                                <div class="shopping_cart">
                                    <div class="cart_box">
                                        <div class="message">
                                            ...
                                            <div class="list_img"><img src="${pageContext.servletContext.contextPath }/assets/images/si.jpg" class="img-responsive" alt=""></div>
                                    ...
                                    <div class="cart_box">
                                        <div class="message1">
                                            ...
                                            <div class="list_img"><img src="${pageContext.servletContext.contextPath }/assets/images/si1.jpg" class="img-responsive" alt=""></div>
                                            <div class="list_desc"><h4><a href="#">velit esse molestie</a></h4>
			...
			<div class="col-md-3 col-md">
				...
				<li><a class="color10" href="#"></a></li>
					...
					<div class="latest-grid">
						<div class="news">
							<a href="single.html"><img class="img-responsive" src="${pageContext.servletContext.contextPath }/assets/images/si.jpg" title="name" alt=""></a>
						</div>
						<div class="news-in">
				...
				<div class="latest-grid">
						<div class="news">
							<a href="single.html"><img class="img-responsive" src="${pageContext.servletContext.contextPath }/assets/images/si1.jpg" title="name" alt=""></a>
						</div>
						<div class="news-in">
							<h6><a href="single.html">Product name here</a></h6>
							<p>Description Lorem ipsum </p>
				...
				<div class="money">
					<h3>Payment Options</h3>
						<ul class="money-in">
						<li><a href="single.html"><img class="img-responsive" src="${pageContext.servletContext.contextPath }/assets/images/p1.png" title="name" alt=""></a></li>
						<li><a href="single.html"><img class="img-responsive" src="${pageContext.servletContext.contextPath }/assets/images/p2.png" title="name" alt=""></a></li>
						<li><a href="single.html"><img class="img-responsive" src="${pageContext.servletContext.contextPath }/assets/images/p3.png" title="name" alt=""></a></li>
						<li><a href="single.html"><img class="img-responsive" src="${pageContext.servletContext.contextPath }/assets/images/p4.png" title="name" alt=""></a></li>
						<li><a href="single.html"><img class="img-responsive" src="${pageContext.servletContext.contextPath }/assets/images/p5.png" title="name" alt=""></a></li>
						<li><a href="single.html"><img class="img-responsive" src="${pageContext.servletContext.contextPath }/assets/images/p6.png" title="name" alt=""></a></li>
						<li><a href="single.html"><img class="img-responsive" src="${pageContext.servletContext.contextPath }/assets/images/p1.png" title="name" alt=""></a></li>
						<li><a href="single.html"><img class="img-responsive" src="${pageContext.servletContext.contextPath }/assets/images/p4.png" title="name" alt=""></a></li>
						<li><a href="single.html"><img class="img-responsive" src="${pageContext.servletContext.contextPath }/assets/images/p2.png" title="name" alt=""></a></li>
